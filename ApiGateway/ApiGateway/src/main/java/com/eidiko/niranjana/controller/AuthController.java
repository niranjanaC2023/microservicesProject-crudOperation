...
import com.eidiko.niranjana.model.AuthResponse;
...
public class AuthController 
{
			                                                 ...
			                                                 @AuthenticationPrincipal OidcUser user, Model model)
	{
		 ...
		 //creatig oauth response object
		 AuthResponse authResponse = new AuthResponse();
		 //set email to authoresponse
		 authResponse.setUserId(user.getEmail());
		 authResponse.setAccessToken(client.getAccessToken().getTokenValue());
		 authResponse.setRefreshToken(client.getRefreshToken().getTokenValue());
		 authResponse.setExpieAt(client.getAccessToken().getExpiresAt().getEpochSecond());
